...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    ceoAdvisor: {
      buttonLabel: 'EgyptSlayer CEO',
      drawerTitle: 'EgyptSlayer Executive Editorial Board',
      ...
      inputPlaceholder: 'Ask EgyptSlayer Chief Editor anything about your layout...',
      sendBtn: 'Send',
      thinking: 'EgyptSlayer Chief Editor is evaluating your design...',
      noKeyWarning: 'Gemini API key is not saved. Please enter your API key in Settings and click Save.',
      clearChat: 'Clear Chat',
      welcomeMsg: 'Welcome to EgyptSlayer Executive Board! I am reviewing your band article, album covers, and page layout. Click any critique button or ask me how to maximize your magazine\'s impact!',
    },
  },
  ar: {
    navbar: {
      ...
      ceoAdvisorBtn: 'رئيس تحرير ايجيبت سلاير',
    },
    settings: {
    ...
    ceoAdvisor: {
      buttonLabel: 'رئيس تحرير ايجيبت سلاير',
      drawerTitle: 'المجلس التنفيذي لمجلة EgyptSlayer',
      ...
      inputPlaceholder: 'اسأل رئيس تحرير EgyptSlayer أي سؤال عن التصميم...',
      sendBtn: 'إرسال',
      ...
      welcomeMsg: 'أهلاً بك في مكتب رئيس تحرير EgyptSlayer! أنا أتابع حالياً تفاصيل المقال وغلاف الألبوم وتنسيق الصفحات. اضغط على أي زر استشارة سريعة أو اسألني كيف تجعل مجلتك أكثر نجاحاً وحضوراً!',
    },
  },
};
